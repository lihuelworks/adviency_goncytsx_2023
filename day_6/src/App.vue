...
<template>
  <div class="app">
    <div class="card">
      ...
      <button @click="addRegalo" class="add-regalo-button">Añadir</button>
      <div v-if="regalos.length">
        <ul class="regalos-list">
          <li v-for="item in regalos" :key="item" class="regalos-item">
            {{ item }}
            <button @click="removeRegalo(item)" class="remove-regalo-button">X</button>
          </li>
        </ul>
      </div>
      <div v-else>
      ...
      <button class="remove-all-regalo-button" @click="removeAllRegalo()">Borrar todos</button>
    </div>
