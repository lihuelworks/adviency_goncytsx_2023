          ...
          <ul class="gift-list">
            <li v-for="(item, index) in gift_array" :id="`${item.gift_name}_${index}`" class="gift-item">
              ...
              <button @click="openCloseDialog('duplicate', item, index)"
                class="gift-item-button gift-item-duplicate-button">📑</button>
              <button @click="openCloseDialog('edit', item, index)"
                class="gift-item-button gift-item-edit-button">📝</button>
              <button @click="removeGift(item, index)" class="gift-item-button gift-item-remove-button">❌</button>
            </li>
            <hr />
...
.card {
  ...
  .gift-list {
    ...
    .gift-item {
      ...
      grid-template-areas:
        "gift-area-icon gift-area-name gift-area-edit-button gift-area-duplicate-button gift-area-remove-button"
        "gift-area-icon gift-area-receiver gift-area-edit-button gift-area-duplicate-button gift-area-remove-button"
      ;
      column-gap: 0.2em;
